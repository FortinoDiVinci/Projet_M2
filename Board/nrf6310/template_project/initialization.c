...
//  nrf_gpio_cfg_input(6,NRF_GPIO_PIN_NOPULL);
  ...
  NRF_GPIO->PIN_CNF[6]=(GPIO_PIN_CNF_SENSE_Low << GPIO_PIN_CNF_SENSE_Pos) //GPIO_PIN_CNF_SENSE_Low
...
void timerVib_init()
{
  ...
  NRF_TIMER2->BITMODE=TIMER_BITMODE_BITMODE_32Bit<< TIMER_BITMODE_BITMODE_Pos; // Mode 16 bits
...
void timerSPI_init()
{
  ...
  NRF_TIMER1->BITMODE=TIMER_BITMODE_BITMODE_32Bit<< TIMER_BITMODE_BITMODE_Pos; // Mode 16 bits
